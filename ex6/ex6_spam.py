...
print('Word Indices: ')
print(word_indices)
# print('len of word indices: %d' %(len(word_indices)))
...
print('Try your own emails...')
email = input('please input the filename of email: ')

file_contents = open(email, 'r').read()
word_indices = pe.process_email(file_contents)
